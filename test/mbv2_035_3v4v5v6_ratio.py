...
for n_mcu, folder in [(3, '3_mcus'), (4, '4_mcus'), (5, '5_mcus'), (6, '6_mcus')]:
    b = parse_log(f'./test/{folder}/coordinator_035_pw_block.log')
    l = parse_log(f'./test/{folder}/coordinator_035_pw_layer.log')
...
plt.tight_layout()
plt.savefig('./test/mbv2_035_3v4v5v6_ratio.png', dpi=300)
# print("Saved to ./test/mbv2_035_4v5_ratio.png")
