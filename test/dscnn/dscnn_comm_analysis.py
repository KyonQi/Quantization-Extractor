...
# 1. 载入数据
b_data = parse_log('./test/5_mcus/coordinator_dscnn_pw_block.log')
l_data = parse_log('./test/5_mcus/coordinator_dscnn_pw_layer.log')
h_data = parse_log('./test/5_mcus/coordinator_dscnn_pw_hybrid.log')
...
plt.tight_layout()
plt.savefig('./test/dscnn/dscnn_comm_analysis.png', dpi=300)
print("Saved to ./test/dscnn/dscnn_comm_analysis.png")
