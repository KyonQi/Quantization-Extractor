...
for n_mcu, folder in [(3, '3_mcus'), (4, '4_mcus'), (5, '5_mcus'), (6, '6_mcus')]:
    ...
    l = parse_log(f'./test/{folder}/coordinator_dscnn_pw_layer.log')
...
ax.set_ylim(0, 100)
ax.set_title('DSCNN Layer Mode: Communication Ratio',
...
plt.tight_layout()
plt.savefig('./test/dscnn/dscnn_3v4v5v6_ratio.png', dpi=300)
