...
# 1. 载入数据
b_data = parse_log('./test/5_mcus/coordinator_proxy_pw_block.log')
l_data = parse_log('./test/5_mcus/coordinator_proxy_pw_layer.log')
h_data = parse_log('./test/5_mcus/coordinator_proxy_pw_hybrid.log')
...
plt.tight_layout()
plt.savefig('./test/proxylessnas/proxy_comm_analysis.png', dpi=300)
print("Saved to ./test/proxylessnas/proxy_comm_analysis.png")
